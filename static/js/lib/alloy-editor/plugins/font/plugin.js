 ...
 */
CKEDITOR.config.font_names = 'IBM Plex Serif/IBM Plex Serif, serif;' +
 ...
 * @member CKEDITOR.config
 */
CKEDITOR.config.fontSize_sizes = '12/12px;14/14px;16/16px;18/18px;20/20px;22/22px;24/24px;26/26px;28/28px;36/36px;48/48px';
